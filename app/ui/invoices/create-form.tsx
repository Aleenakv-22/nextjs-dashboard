...
export default function Form({ customers }: { customers: CustomerField[] }) {
  ...
  // Local state for fields and errors
  ...
  //   // For radio, status is always string
  //   if (name === "amount") {
  //     data.amount = value;
  //   }
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                className="peer block w-full rounded-md border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
                value={fields.amount}
                onChange={handleChange}
                onBlur={handleBlur}
                required
